...
<div class="container">
    ...
    <form action="{{ route('softwares.update', $software->software_id) }}" method="POST">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <input
                    ...
                    id="f_name"
                    class="form-control"
                    value="{{ old('f_name', $software->f_name) }}"
                    required>
            </div>
            <div class="col-md-4">
                ...
                <input
                    ...
                    id="l_name"
                    class="form-control"
                    value="{{ old('l_name', $software->l_name) }}"
                    required>
            </div>
            <div class="col-md-4">
        ...
        <div class="mb-3">
            ...
            <input
                ...
                value="{{ old('software_name', $software->software_name) }}"
                required>
        </div>
        ...
        <div class="d-flex justify-content-end">
            <a
                href="{{ route('softwares.show', $software->software_id) }}"
    ...
    <ul id="fileList" class="list-group mt-2">
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <button
                class="btn btn-danger btn-sm deleteFileBtn"
                data-file-id="{{ $file->files_id }}">
                ลบ
            </button>
        </li>
        @endforeach
