...
<div class="container">
    ...
    <ul class="nav nav-pills mb-3" id="timelineTabs" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="duration-tab" data-bs-toggle="pill" data-bs-target="#duration-content" type="button" role="tab" aria-controls="duration-content" aria-selected="false">
                ระยะเวลาพัฒนา
            </button>
        </li>
    </ul>
